...
const mauticConnector = new MauticConnector({
  apiUrl: 'https://mautic-dev.breeze4me.de',
  username: 'zheng',
  password: 'gYWFLn7KFdDEMYty',
  timeoutInSeconds: 5
});
const client = new Mautic({
  baseUrl: 'https://mautic-dev.breeze4me.de',
  auth: {
    username: 'zheng',
    password: 'gYWFLn7KFdDEMYty'
  }
...
class AccountController {
  ...
  async login({ request, auth, response }) {
    ...
    // const mauticData = await client.contacts.create({
    //   firstname: 'Luiz',
    //   lastname: 'Freneda',
    //   email: 'luiz@freneda.com.br',
    // })
  // const mauticData = await mauticConnector.contacts.createContact(fieldKeyToValueMap);
  console.log("!!!!!!!!!!!!!!,",await mauticConnector.contacts.getContact('21'))
